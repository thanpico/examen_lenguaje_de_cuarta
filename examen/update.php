  ...
  <body>
        ...
        <div class="dad_formu">
          ...
          <form class="formu" action="update.php" method="post">
            <h3 class = "hey">Modificar publicacion</h3>
        ...
        if (isset($_POST['select'])) {
          ...
          $existe = 0;
          if ($titulo=="") {
            echo "Para modificar debes ingresar el titulo de la publicacion";
          }else {
            $resultados = mysqli_query($conexion, "SELECT * FROM posts WHERE title = '$titulo'");
            while ($consulta = mysqli_fetch_array($resultados)) {
              echo "<div class='dad_formu'>

                <form class='formu' action='update_formulario.php' method='post'>
                  <h3 class = 'hey'>Modificar publicacion</h3>

                  <label></label>
                  <input type='text' name='tittle' value=".$consulta['title'].">

                  <label></label>
                  <textarea name='content' rows='9' cols='69' placeholder='Contenido del Articulo'>".$consulta['content']."</textarea>
                  ...
                  <input class='btn' type='submit' value='Modificar' name='Modificar'>
                </form>
              </div>";
              $existe++;
            }
